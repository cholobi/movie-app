        ...
        <div className='flex justify-between gap-4'>
          <div className="px-1">
            <div className="flex justify-between">
              ...
              <a href="#" className="text-sm text-zinc-50/30 transition-colors hover:text-white">View more</a>
            </div>
            {response.isLoading ? (
          ...
          <div className=" px-2">
            <div className="flex justify-between">
              <h1 className="text-lg font-bold mb-2">My watchlist ({response.data?.length})</h1>
              <a href="#" className="text-sm mb-2 text-zinc-400 hover:text-white">View more</a>
            </div>
            {response.isLoading ? (
              <div className='grid grid-cols-4 animate-pulse mt-6 gap-4'>
                {[1, 2, 3, 4].map(() => (
